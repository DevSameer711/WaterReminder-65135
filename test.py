import pytest
from water_rem import calculate_water_intake, get_reminder_interval

def test_calculate_water_intake():
    assert calculate_water_intake(70, 25) == 2.45  # This is correct
    assert calculate_water_intake(40, 10) == 1.3   # ❌ Intentionally wrong (actual is 1.2)
